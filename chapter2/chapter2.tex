...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=0.8\textwidth]{TTU_peamine_logo_EST_print}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=0.8\textwidth]{TTU_alternatiivne_logo_EST_ENG_print}
...
\begin{figure}[!ht]
  ...
  \begin{subfigure}[b]{0.45\textwidth}
    \includegraphics[width=\textwidth]{TTU_peamine_logo_ENG_print}
    \caption{}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.45\textwidth}
    \includegraphics[width=\textwidth]{ttu_peamine_logo_eng_must-valge_negatiivis}
    \caption{}
  \end{subfigure}
